...
class Eights {
    ...
    class Game(initialPlayers: List<Player>): CanSummarize{
         ...
         */
        // bug found with help from pyrozord on libera/##programming

        fun validateAttempt(a: Attempt): Boolean = when{
            a.value == lastValue -> true
            a.suit == lastSuit -> true
            else -> (StaticRules.wildValues.contains(a.value)
                    && CardsCompanion.normalSuits.contains(a.suit))
        }
        /**
